...
export const WaterCooler: React.FC = () => (
  <div className="decoration-item" aria-label="Water cooler">
    <svg width="40" height="64" viewBox="0 0 40 64" fill="none">
      {/* Water jug */}
      <rect x="12" y="2" width="16" height="22" rx="4" fill="#93C5FD" opacity="0.7" />
      <rect x="14" y="6" width="12" height="14" rx="2" fill="#BFDBFE" opacity="0.5" />
      {/* Body */}
      ...
      {/* Water bubbles */}
      <circle cx="18" cy="10" r="1" fill="#fff" opacity="0.6" />
      <circle cx="22" cy="14" r="0.8" fill="#fff" opacity="0.5" />
    </svg>
  </div>
);

/** A cute potted plant SVG */
export const PlantPot: React.FC = () => (
  <div className="decoration-item" aria-label="Office plant">
    <svg width="36" height="56" viewBox="0 0 36 56" fill="none">
      {/* Pot */}
      <path d="M8 34 L6 52 Q6 54 8 54 L28 54 Q30 54 30 52 L28 34 Z" fill="#D97706" />
      ...
      <ellipse cx="11" cy="10" rx="5" ry="8" fill="#22C55E" transform="rotate(-20 11 10)" />
...
export const Whiteboard: React.FC<WhiteboardProps> = ({
  ...
  <div className="decoration-item" aria-label="Office whiteboard">
    <svg width="80" height="56" viewBox="0 0 80 56" fill="none">
      ...
      {/* Text on board */}
      <text x="40" y="24" textAnchor="middle" fontSize="7" fontWeight="600" fill="#334155">
        {text}
      </text>
      <text x="40" y="36" textAnchor="middle" fontSize="6" fill="#64748B">
